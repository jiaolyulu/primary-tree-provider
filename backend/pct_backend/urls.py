...
from providers.views import provider_browse_search, provider_coords, provider_detail, provider_search, status


urlpatterns = [
    path("status/", status, name="status"),
    path("api/providers/search", provider_search, name="provider-search"),
    path("api/providers/browse-search", provider_browse_search, name="provider-browse-search"),
